...
class TasksController extends AppController
{
    ...
    public function index()
    {
        $this->paginate = [
            'contain' => ['Categories'],
            'order' => ['Tasks.category_id' => 'ASC', 'Tasks.position' => 'ASC']
        ];
    ...
    public function add()
    {
        ...
        $this->set('max', 65535);
        $this->set('step', $this->Tasks->getStep());
    ...
    public function edit($id = null)
    {
        ...
        $this->set('max', $this->Tasks->getLast());
        $this->set('min', $this->Tasks->getStart($conditions));
        $this->set('max', $this->Tasks->getNew($conditions));
        $this->set('step', $this->Tasks->getStep());
        $this->set(compact('task', 'categories'));
    }
